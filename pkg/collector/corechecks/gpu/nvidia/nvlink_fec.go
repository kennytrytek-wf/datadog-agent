...
func newNVLinkFECCollector(device ddnvml.Device, port int, _ *CollectorDependencies) (Collector, error) {
	return &nvlinkFECCollector{device: device, port: port}, nil
}
