...
// ConditionTypeProvider can be implemented by handlers that need controller-generated
// validation statuses before Handle is called.
type ConditionTypeProvider interface {
