...
// ConditionType returns the status condition owned by the Autodiscovery handler.
func (h *AutodiscoveryHandler) ConditionType() string {
	return checksReadyConditionType
}
...
func (h *AutodiscoveryHandler) Handle(_ context.Context, _ instrumentation.EventType, _ *datadoghq.DatadogInstrumentation) (instrumentation.HandlerStatus, error) {
	// TODO: Implement check translation and delivery in the follow-up Autodiscovery handler phase.
