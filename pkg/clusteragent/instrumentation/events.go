...
func newQueueItem(key string, oldObj, newObj *datadoghq.DatadogInstrumentation) queueItem {
	var oldCopy, newCopy *datadoghq.DatadogInstrumentation
	if oldObj != nil {
	...
	return queueItem{key: key, old: oldCopy, new: newCopy}
}
